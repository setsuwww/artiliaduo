...
export default function AboutRightContent() {
  return (
    ...
    >
      <div>
        <h3 className="section-header text-2xl md:text-5xl font-bold mb-6">{AboutData.journey.title}</h3>
        <p className="shiny-text leading-relaxed mb-4">{AboutData.journey.description}</p>
      </div>
